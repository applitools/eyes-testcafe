...
const makeClientFunctionExecuter = require('../../src/makeClientFunctionExecuter');
...
test('Basic CDT test', async (/* t */) => {
  const processPageClientFunction = await clientFunctionExecuter(processPageAndSerialize);
