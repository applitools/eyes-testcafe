...
const wrapBundle = require('@applitools/dom-snapshot/dist/processPageAndSerialize');
const path = require('path')

const processPageAndSerializePath = path.resolve(__dirname, 'node_modules/@applitools/dist')
